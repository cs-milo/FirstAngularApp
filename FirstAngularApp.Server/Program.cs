...
using FirstAngularApp.Core.Infrastructure;
using FirstAngularApp.Core.Models.Account;
using FirstAngularApp.Core.Services;
using FirstAngularApp.Core.Services.Account;
using FirstAngularApp.Core.Services.Shop;
using FirstAngularApp.Server.Authorization;
using FirstAngularApp.Server.Authorization.Requirements;
using FirstAngularApp.Server.Configuration;
using FirstAngularApp.Server.Services;
using FirstAngularApp.Server.Services.Email;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - FirstAngularApp";
