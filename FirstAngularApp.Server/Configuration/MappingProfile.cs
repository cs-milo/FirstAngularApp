...
using FirstAngularApp.Core.Models.Shop;
using FirstAngularApp.Core.Services.Account;
using FirstAngularApp.Server.ViewModels.Account;
using FirstAngularApp.Server.ViewModels.Shop;
using Microsoft.AspNetCore.Identity;

namespace FirstAngularApp.Server.Configuration
{
